...
import 'package:glx_gram/page/page.dart';
...
import "package:glx_gram/database/scheme/scheme.dart"
    as isar_scheme;

class GlxGram extends StatefulWidget {
  const GlxGram({super.key});

  @override
  State<GlxGram> createState() => _GlxGramState();
}

class _GlxGramState extends State<GlxGram> {
  bool is_found = false;
  int count = 0;
